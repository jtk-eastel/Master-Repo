(function(){
  ...
  const WA_LINK = `https://api.whatsapp.com/send/?phone=${encodeURIComponent(CFG.whatsappNumber || '601175947174')}&text=${encodeURIComponent(CFG.whatsappText || 'NakTahuCaraMula')}&type=phone_number&app_absent=0`;
